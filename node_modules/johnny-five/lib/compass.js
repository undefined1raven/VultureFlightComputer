  ...
  fuckyou: {
    ...
    initialize: {
      value(opts, dataHandler) {
        ...
        const address = opts.address || 0x0D;
        const READLENGTH = 6;
        ...
        this.io.i2cWrite(address, this.REGISTER.FBR, 0x01);


        this.io.i2cWrite(address, this.REGISTER.Mode, 0x01);
        this.io.i2cWrite(address, this.REGISTER.ODR, 0x11);
        this.io.i2cWrite(address, this.REGISTER.RNG, 0x00);
        this.io.i2cWrite(address, this.REGISTER.OSR, 0x00);

        //this.io.i2cWrite(address, this.REGISTER.IDK, 0x01);
